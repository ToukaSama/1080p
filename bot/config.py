...
class Config(object):
    ...
    AUTH_USERS = get_config("AUTH_USERS", "6440021089")
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "8282154810:AAFaNdQQ5neWMkOoZUTNZx2C-rZuhU-Ic2A")
    # the download location, where the HTTP Server runs
    DOWNLOAD_LOCATION = get_config("DOWNLOAD_LOCATION", "/app/downloads")
    # Telegram maximum file upload size
    BOT_USERNAME = get_config("BOT_USERNAME", "Enc_prvtbot")
    MAX_FILE_SIZE = 2097152000
    TG_MAX_FILE_SIZE = 2097152000
    FREE_USER_MAX_FILE_SIZE = 2097152000
    # default thumbnail to be used in the videos
    DEF_THUMB_NAIL_VID_S = get_config("DEF_THUMB_NAIL_VID_S", "None")
